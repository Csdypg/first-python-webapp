...
# -*- coding:utf-8 -*-
'''
A simple, lightweight, WSGI-compatibel web framework.
'''
...
# timezone ad UTC+8:00, UTC-10:00
...
class Route(object):
    ...
    def __str__(self):
        ...
        return 'Route(dynamic, %s, path=%s)' % (self,nethod, self.path)
...
class Request(object):
    ...
    def _parse_input(self):
        ...
        fs = cgi.FieldStorage(fp=self.environ['wsgi.input'], environ=self._environ, keep_blank_values=True)
        inputs = dict()
        for k in fs:
    ...
    def _get_raw_input(self):
        '''
        Get raw input as dict containing values as unicode , list or multipart.
        '''
    ...
    def status(self, value):
        ...
        if isinstance(value, (int, long)):
            if value>=100 and value <=999:
                ...
                raise ValueError('Bad respose code: %d' % value)
            ...
            raise TypeError('Bad of respose code.') 
